...
import com.mycompany.myapp.service.MovimientoQueryService;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Movimiento}.
 */
@RestController
@RequestMapping("/api")
public class MovimientoResource {
    ...
    public ResponseEntity<List<Movimiento>> getAllMovimientos(
        MovimientoCriteria criteria,
        @org.springdoc.api.annotations.ParameterObject Pageable pageable
    ) {
        log.debug("REST request to get Movimientos by criteria: {}", criteria);
        Page<Movimiento> page = movimientoQueryService.findByCriteria(criteria, pageable);
