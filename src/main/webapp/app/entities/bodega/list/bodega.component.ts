...
export class BodegaComponent implements OnInit {
  ...
  loadAll(): void {
    ...
    this.bodegaService
      ...
      .subscribe({
        next: (res: HttpResponse<IBodega[]>) => {
          this.isLoading = false;
          this.paginateBodegas(res.body, res.headers);
        },
        error: () => {
          this.isLoading = false;
        },
  ...
  trackId(index: number, item: IBodega): number {
    return item.id!;
  }
  ...
  protected paginateBodegas(data: IBodega[] | null, headers: HttpHeaders): void {
