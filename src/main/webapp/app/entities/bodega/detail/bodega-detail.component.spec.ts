...
describe('Bodega Management Detail Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      declarations: [BodegaDetailComponent],
      providers: [
        {
          provide: ActivatedRoute,
          useValue: { data: of({ bodega: { id: 123 } }) },
        },
      ],
    })
  ...
  describe('OnInit', () => {
    it('Should load bodega on init', () => {
      // WHEN
      comp.ngOnInit();

      // THEN
      expect(comp.bodega).toEqual(expect.objectContaining({ id: 123 }));
    });
  });
