...
describe('ComprobanteContable Management Component', () => {
  let comp: ComprobanteContableComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(ComprobanteContableComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.comprobanteContables[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
