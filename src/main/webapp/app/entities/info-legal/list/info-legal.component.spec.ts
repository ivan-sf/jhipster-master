...
describe('InfoLegal Management Component', () => {
  let comp: InfoLegalComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(InfoLegalComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.infoLegals[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
